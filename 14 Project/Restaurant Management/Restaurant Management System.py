...
#-----------------INFO TOP------------
lblinfo = Label(Tops, font=('ariel',30,'bold'), text="Restaurant Management System",
                fg="steel blue", bd=10,
                anchor='w')
lblinfo.grid(row=0,column=0)
lblinfo = Label(Tops, font=('ariel',20,'bold'), text=localtime, fg="steel blue",
                anchor='w')
...
txtdisplay = Entry(f2,font=('ariel',20,'bold'), textvariable=text_Input, bd=5,
...
Substraction = Button(f2, padx=16, pady=16, bd=4, fg="black",
                      font=('ariel',20,'bold'), text="-", bg="powder blue",
...
status = Label(f2, font=('aria',15,'bold'), width=16, text="-By XXXXXX", bd=2,
               relief=SUNKEN)
