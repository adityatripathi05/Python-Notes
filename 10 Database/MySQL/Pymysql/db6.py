...
row = cur.fetchmany(3)
print(row)
'''fetchmany() method will fetch as much no. of row from table inside the cursor and return
as a tuple of tuple and cursor is positioned as many no. ofs step ahead from its previous
position. Bydefault it will fetch only one row'''
